import type { AuthorPlatformBillingDto, AuthorPlatformCleanupPreviewDto, PlatformPlanDto } from "@shared/types/content"
import { AlertTriangle, CreditCard, HardDrive } from "lucide-react"
    ...
    return (
        <Card className="rounded-[26px] border-rose-200 bg-rose-50 text-slate-950">
            <CardContent className="grid gap-4 p-5">
                ...
                {mutationError ? <p className="text-sm text-rose-700">{mutationError.message}</p> : null}
            </CardContent>
        </Card>
    )
}
