...
export function SheetContent({
    ...
    return (
        <aside
            className={cn(
                "absolute right-0 bottom-0 left-0 max-h-[88vh] overflow-y-auto rounded-t-[34px] border border-[var(--line)] bg-[var(--surface)] p-6 shadow-2xl animate-in slide-in-from-bottom-10 md:top-0 md:left-auto md:h-full md:max-h-none md:w-full md:max-w-xl md:rounded-l-[34px] md:rounded-tr-none md:slide-in-from-right-10",
                className
            )}
        >
            {onClose ? (
